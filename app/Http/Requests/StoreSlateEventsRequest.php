...
class StoreSlateEventsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'events.*' => ['array:event_type,category,metro_id,marketplace_life_stage_id,life_stage,provider_id,slot_position,sponsored,occurred_at'],
            ...
            'events.*.marketplace_life_stage_id' => ['nullable', 'integer', 'exists:marketplace_life_stages,id'],
            'events.*.life_stage' => ['nullable', 'string', 'exists:marketplace_life_stages,slug'],
