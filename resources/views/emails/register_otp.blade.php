...
<html>
<head>
    <title>Welcome to NUEMERA - Verify Email</title>
</head>
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px; margin: 0;">
    <div style="max-width: 600px; margin: 0 auto; background: #fff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
        ...
        <p style="color: #555; font-size: 16px; line-height: 1.5;">Thank you for registering with NUEMERA! To complete your registration and verify your email address, please use the OTP code provided below. This code is valid for 5 minutes.</p>
        ...
        <p style="color: #777; font-size: 14px; line-height: 1.5;">Regards,<br><strong style="color: #10B981;">NUEMERA</strong></p>
    </div>
</body>
</html>